...
- **Vertex AI Gemini Client**: Interfaces with `gemini-3.5-flash-lite` in [`VertexAI.kt`](file:///home/almo/Engineering/Machine-Learning/AI4Media/backend/AI4MediaServer/src/main/kotlin/com/catharsis/ai4media/ai4mediaserver/Utils/VertexAI.kt).
...
| **AI / Machine Learning** | Google Cloud Vertex AI | Gemini LLM (`gemini-3.5-flash-lite`) copy synthesis |
