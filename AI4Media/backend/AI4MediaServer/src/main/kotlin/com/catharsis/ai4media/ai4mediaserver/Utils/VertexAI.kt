...
class GeminiClient(
    ...
    private val generativeModel = GenerativeModel.Builder()
    ...
    /**
     * Generates content. Executes on the IO dispatcher to ensure the underlying network call
     * doesn't block the calling thread.
     */
    suspend fun generateContent(prompt: String): GenerateContentResponse =
            withContext(Dispatchers.IO) { generativeModel.generateContent(prompt) }
